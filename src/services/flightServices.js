...
export const getAllFlights = async (req) => {
  try {
    ...
    // const flights = formattedFlightsDummy.slice(startIndex, endIndex);
    const flights = formattedFlightsDummy;

    // const totalItems = formattedFlightsDummy.length;
