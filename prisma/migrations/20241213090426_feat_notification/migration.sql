...
-- CreateEnum
CREATE TYPE "PassengerType" AS ENUM ('Dewasa', 'Anak', 'Bayi');

-- CreateEnum
CREATE TYPE "TitleType" AS ENUM ('Mr', 'Ms');

-- CreateEnum
CREATE TYPE "RegionType" AS ENUM ('Domestik', 'Internasional');

-- CreateEnum
CREATE TYPE "Continent" AS ENUM ('Afrika', 'Amerika', 'Asia', 'Europa', 'Australia');
